...
DOWNLOAD_DIR = '/data/af_db' # SET TO TARGET OF DB SCRIPT

# Name of the AlphaFold Docker image.
docker_image_name = 'alphafold_jsb'
...
flags.DEFINE_integer('n_models', 5, 'Number of models to use.')
FLAGS = flags.FLAGS
...
def main(argv):
  ...
  command_args.extend([
      ...
      f'--model_names={",".join(model_names[:FLAGS.n_models])}',
